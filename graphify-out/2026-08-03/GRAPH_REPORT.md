# Graph Report - kanka-voice  (2026-08-03)

## Corpus Check
- 107 files · ~635,425 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1124 nodes · 2377 edges · 90 communities (67 shown, 23 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5f5789e4`
...
Cohesion: 0.03
Nodes (51): ACTIVITY_CARD_IDS, AUDIO_CHANNEL_FIELDS, badWordsList, badWordsRegex, chatBlobUrls, closeJoinRequestNote(), ctrlOfferAcceptBtn, ctrlOfferDenyBtn (+43 more)
...
Cohesion: 0.11
Nodes (41): addUser(), addVideoCard(), appendChat(), applyMicState(), broadcast(), broadcastTo(), checkAvatar(), checkTextWithAI() (+33 more)
...
Cohesion: 0.13
Nodes (29): applyPeerLimiter(), applyPeerVolume(), AUDIO_CHANNELS, buildCardVolumeBox(), buildMenuVolumeBlock(), channelFields(), ensurePeerBoostChain(), getNickname() (+21 more)
...
Cohesion: 0.15
Nodes (21): applyAudioBitrateToPeers(), applyPttMode(), applyRoomNoiseSuppression(), bindUI(), canManageRoom(), canModerateTarget(), getAudioBitrate(), getShareableTurn() (+13 more)
...
Cohesion: 0.11
Nodes (39): APP_THEMES, applyCustomThemeColors(), applyMicrophoneVolume(), applySimpleUi(), applySpeakerVolume(), applyUserTheme(), CUSTOM_THEME_PRESETS, fillAudioDeviceSelect() (+31 more)
...
Cohesion: 0.13
Nodes (19): acceptServerInvite(), appendFileMsg(), closeAllCards(), connectGlobalBroker(), disconnectApp(), escapeHtml(), initFileTransfer(), isImageFile() (+11 more)
...
### Community 88 - "founder-rnnoise-toggle.test.js"
Cohesion: 0.40
...
- **Why does `t()` connect `Cross-Fetch Dependency` to `Chat & Renderer Utilities`, `handlePeerDiscovered`, `Poke Feature Init`, `WebRTC ICE & TURN`, `Focus Mode UI`, `escapeHtml`, `enterFocus`?**
