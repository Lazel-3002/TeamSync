...
Cohesion: 0.05
Nodes (32): appendFileMsg(), badWordsList, badWordsRegex, chatBlobUrls, fileBuffer, getActiveActivity(), hostPassivePointer, initFileTransfer() (+24 more)
...
Cohesion: 0.18
Nodes (23): addVideoCard(), broadcastTo(), checkTextWithAI(), closeActiveControlSession(), closeCtrlModal(), decryptMsg(), handleDataMessage(), makeCardFocusable() (+15 more)

### Community 9 - "Room Moderation & Audio Controls"
Cohesion: 0.16
Nodes (22): applyAudioBitrateToPeers(), applyMicState(), applyPttMode(), applyRoomNoiseSuppression(), bindUI(), broadcast(), canManageRoom(), canModerateTarget() (+14 more)
...
Cohesion: 0.12
Nodes (17): acorn, crypto-js, @ghostery/adblocker-electron, @jitsi/robotjs, dependencies, acorn, crypto-js, @ghostery/adblocker-electron (+9 more)
...
Cohesion: 0.16
Nodes (21): applyPeerVolume(), applySpeakerTo(), applySpeakerToAll(), ensurePeerBoostChain(), getNickname(), getUserVolume(), intendedPeerVolumeIsZero(), logVoicePathReport() (+13 more)
