...
## Corpus Check
- 112 files · ~658,645 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1300 nodes · 2907 edges · 91 communities (69 shown, 22 thin omitted)
...
Cohesion: 0.03
Nodes (79): acceptServerInvite(), AUDIO_CHANNEL_FIELDS, badWordsList, badWordsRegex, beginRoomOperation(), chatBlobUrls, checkSession(), closeJoinRequestNote() (+71 more)
...
Cohesion: 0.07
Nodes (62): addUser(), addVideoCard(), appendChat(), appendFileMsg(), applyAudioBitrateToPeers(), applyMicState(), applyPttMode(), applyRoomNoiseSuppression() (+54 more)
...
Cohesion: 0.10
Nodes (34): ACTIVITY_CARD_IDS, applyPttShortcut(), beginShortcutRebind(), cancelShortcutRebind(), getPttAccelerator(), getShortcutBinding(), getShortcutsMasterEnabled(), handleShortcutGateKeydown() (+26 more)
...
Cohesion: 0.11
Nodes (26): adoptScreenAudioTransceiver(), applyAudioSdpParams(), applyIceEscalationPolicy(), applyScreenAudioQuality(), applySharedTurn(), applySpeakerTo(), attachPeerScreenAudio(), attachVideo() (+18 more)
...
Cohesion: 0.24
Nodes (17): clearFocusInlineLayout(), closeAllCards(), ensureFocusControlsVisible(), enterFocus(), exitFocus(), makeCardFocusable(), minimizeFocus(), openCardFocused() (+9 more)
...
Cohesion: 0.12
Nodes (40): APP_THEMES, applyCustomThemeColors(), applyMicrophoneVolume(), applySimpleUi(), applySpeakerToAll(), applySpeakerVolume(), applyUserLanguage(), applyUserTheme() (+32 more)
...
Cohesion: 0.16
Nodes (21): detectTunnelInterference(), diagnoseIceFailure(), dohResolve(), expandTurnFamily(), expandTurnWithIpVariants(), getIceServers(), getNickname(), getTurnIpCache() (+13 more)
...
Cohesion: 0.06
Nodes (100): accentColor(), addOps(), announceRemoteActivity(), applyLive(), bboxOf(), bindUI(), buildSwatches(), call() (+92 more)
...
- **Why does `t()` connect `Cross-Fetch Dependency` to `Chat & Renderer Utilities`, `handlePeerDiscovered`, `Poke Feature Init`, `Audio Bitrate & Mic Controls`, `Electron Builder Config`, `WebRTC ICE & TURN`, `showToast`?**
