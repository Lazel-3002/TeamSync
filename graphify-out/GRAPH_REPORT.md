...
## Corpus Check
- 87 files · ~526,923 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 965 nodes · 1971 edges · 81 communities (60 shown, 21 thin omitted)
...
Cohesion: 0.04
Nodes (58): appendFileMsg(), badWordsList, badWordsRegex, chatBlobUrls, checkSession(), closeJoinRequestNote(), connectGlobalBroker(), CUSTOM_THEME_DEFAULTS (+50 more)
...
Cohesion: 0.14
Nodes (27): addVideoCard(), attachVideo(), broadcastTo(), checkTextWithAI(), closeActiveControlSession(), closeCtrlModal(), decryptMsg(), getVideoConstraints() (+19 more)
...
Cohesion: 0.22
Nodes (13): acceptServerInvite(), addUser(), appendChat(), checkAvatar(), cleanText(), displayName(), escapeHtml(), handlePeerDiscovered() (+5 more)
