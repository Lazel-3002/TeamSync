# Graph Report - fix-server-dm-routing  (2026-07-22)

## Corpus Check
- 69 files · ~181,797 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 626 nodes · 1139 edges · 61 communities (40 shown, 21 thin omitted)
...
Cohesion: 0.07
Nodes (19): appendChat(), appendFileMsg(), badWordsList, badWordsRegex, chatBlobUrls, cleanText(), fileBuffer, initFileTransfer() (+11 more)
...
Cohesion: 0.47
Nodes (6): attachVideo(), broadcast(), getVideoConstraints(), getVideoSender(), startScreenShare(), stopScreenShare()
...
Cohesion: 0.26
Nodes (14): addUser(), applyRoomNoiseSuppression(), applySpeakerTo(), applySpeakerToAll(), openServerDM(), refreshDynamicTurn(), requestControl(), resolvePeerFriendId() (+6 more)
